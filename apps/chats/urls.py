...
from .views import ChatListView, ChatMessageListAPIView, StartChatView, ChatDetailView
...
urlpatterns = [
    ...
    path('api/chats/<int:pk>/messages/', ChatMessageListAPIView.as_view(), name='chat_messages_api'),
]
